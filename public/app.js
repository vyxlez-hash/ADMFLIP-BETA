(() => {
  ...
  Roblox requests are handled by the Render backend.
  The browser does NOT call Roblox directly.
  ============================================================
  */
  ...
  async function api(path, options = {}) {
    ...
    try {
      ...
      console.error(
        "ADMFLIP backend connection:",
        error
      );

      throw new Error(
        "The ADMFLIP backend cannot be reached right now."
      );
    }
  ...
  function renderPhrase(phrase) {
    ...
    box.innerHTML = `
      ...
      <p>
        Copy this exact phrase into your
        Roblox Profile → About/Bio.
      </p>
    `;
  ...
  async function verifyRobloxBio() {
    ...
    try {
      ...
      /*
        ...
        Verification is done by Render.
  ...
  async function loadInventory() {
    ...
    try {
      ...
      if (!pets.length) {
        ...
        grid.innerHTML =
          `<div class="loading">
            No pets are available in your inventory.
          </div>`;
  ...
  async function init() {
    ...
    /*
      ...
      A broken chat request won't stop values.
    */
